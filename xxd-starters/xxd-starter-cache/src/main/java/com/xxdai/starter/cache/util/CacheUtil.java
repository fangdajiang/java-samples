package com.xxdai.starter.cache.util;
...
*/
     ...
     * @param time 失效时间(秒)
     */
    public static void set(String key,Object value,ExpiryTime time){
        log.debug("key:{}, value:{}, time:{}, value.getClass()", key, value, time, value.getClass());
        ...
        log.debug("time.getTime():{}", time.getTime());
        if(time.getTime() > 0){
     ...
     */
/*
    public static void setJson(String key,Object value,ExpiryTime time){
...
*/
     ...
     * @param time 失效时间(秒)
     */
    public static void setDouble(String key, double value, ExpiryTime time) {
     ...
     * @param time 失效时间(秒)
     */
    public static void setInt(String key, int value, ExpiryTime time) {
        stringRedisTemplate.opsForValue().set(key, String.valueOf(value));
        if(time.getTime() > 0){
            stringRedisTemplate.expire(key, time.getTime(), TimeUnit.SECONDS);
        }
     ...
     * @param time 失效时间(秒)
     */
    public static <T> void setMap(String key, Map<String, T> map, ExpiryTime time){
...
/*
    @SuppressWarnings("unchecked")
    public static <T> void setMap(String key, T obj, ExpiryTime time){
...
*/
     ...
     * @param time 失效时间(秒)
     */
    public static void expire(String key, ExpiryTime time) {
        if(time.getTime() > 0){
            redisTemplate.expire(key, time.getTime(), TimeUnit.SECONDS);
        }
    }
